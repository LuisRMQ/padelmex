...
export class RegistrarHorarioDialogComponent {
    ...
    days: DaySchedule[] = [
        { name: 'Lunes', enabled: false, start: '12:00 AM', end: '11:30 PM', hasSchedule: false, schedules: [] },
        { name: 'Martes', enabled: false, start: '12:00 AM', end: '11:30 PM', hasSchedule: false, schedules: [] },
        { name: 'Miercoles', enabled: false, start: '12:00 AM', end: '11:30 PM', hasSchedule: false, schedules: [] },
        { name: 'Jueves', enabled: false, start: '12:00 AM', end: '11:30 PM', hasSchedule: false, schedules: [] },
        { name: 'Viernes', enabled: false, start: '12:00 AM', end: '11:30 PM', hasSchedule: false, schedules: [] },
        { name: 'Sabado', enabled: false, start: '12:00 AM', end: '11:30 PM', hasSchedule: false, schedules: [] },
        { name: 'Domingo', enabled: false, start: '12:00 AM', end: '11:30 PM', hasSchedule: false, schedules: [] },
    ];

    hours: string[] = ['12:00 AM', '12:30 AM', '1:00 AM', '1:30 AM',
